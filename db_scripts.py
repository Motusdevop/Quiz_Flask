...
def add_questions():
    questions = [
        ...
        ("Назовите синоним к слову Доброволец","Волонтер","Помощник","Рабочий","Военный"),
        ("Сколько метров в сантиметре?","0,01","0,1","10","100"),
        ("Какой норматив НЕ сдается в школе?","Бег с препятствиями","Отжимания","Метание мяча","Прыжки в длину"),
        ("Назовите самое вкусное лекарство Карлсона?","варенье","микстура","настойка","шоколад")
    ]
    open()
